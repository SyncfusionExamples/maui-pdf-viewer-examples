...
3. Base64 string converted PDF text file. In your project, create a folder named Assets (if it doesn't already exist), add the text file containing base64 string text file (For example PDFEncodedBase64String.txt) in the Assets folder of your project, and set its Build Action to EmbeddedResource. The pdf which is converted as base64 string text is which has 62 pages.
