...
namespace TextMarkups
{
    public class EditorControl : Border
    {
        ...
        internal event EventHandler<SliderValueChangedEventArgs> OpacityChanged;
        ...
        internal void ConfigureThickness(int value)
        {
            ThicknessSlider.Value = value;
    ...
    /// <summary>
    /// Event arguments for the color changed event.
    /// </summary>
