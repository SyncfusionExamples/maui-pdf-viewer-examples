...
namespace Ink
{
    public class EditorControl : Border
    {
        ...
        /// <summary>
        /// Configures and adds a color picker to the ControlLayout using the provided colorCodes.
        /// </summary>
        /// <param name="colorCodes">A two-dimensional array containing color codes for configuring the color picker.</param>
        ...
        /// <summary>
        /// Event handler for the "ValueChangeEnd" event of the OpacitySlider.
        /// Updates the EditorOpacity property based on the slider's current value and invokes the OpacityChangedEnd event.
        /// </summary>
        /// <param name="sender">The object that triggered the event (OpacitySlider).</param>
        ...
        /// <summary>
        /// Event handler for the "ValueChangeEnd" event of the ThicknessSlider.
        /// Updates the EditorThickness property based on the slider's current value and invokes the ThicknessChangedEnd event.
        /// </summary>
        /// <param name="sender">The object that triggered the event (ThicknessSlider).</param>
        /// <param name="e">The EventArgs associated with the event.</param>
