...
{
    /// <summary>
    /// Main page of the PDF Auto-Save application.
    /// Handles PDF viewing, editing events, and coordinates with the ViewModel for auto-save functionality.
    /// </summary>
    public partial class MainPage : ContentPage
    {
        ...
        /// Sets up the ViewModel, data binding, and PDF Viewer reference.
        /// </summary>
        public MainPage()
        {
            InitializeComponent();
        ...
        #region PDF Viewer Event Handlers
